...
import {fetchGoodsList, fetchGoodsListPage} from "../../actions/goodsActions";
...
function GoodsList(){
    ...
    const goodsList = useSelector((state)=>state.goods.goods_list)

    useEffect(() => {

        dispatch(fetchGoodsList(curpage))
